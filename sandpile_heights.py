...
pile = avalanche.avalanche2D(nx = nx, ny = ny, sigma_critical = sigma_critical, 
				slide_rule = 0, boundary = [0,0,0,0], calc_slope_rule = 1)
...
if movie:
	...
	ani = animation.FuncAnimation(fig, plotting, interval = 100, frames=grain_number/1000,
					fargs = (heights_array[0], surf), blit = False)
	ani.save('sand_pile_movie.mp4', codec="libx264", bitrate=-1)
